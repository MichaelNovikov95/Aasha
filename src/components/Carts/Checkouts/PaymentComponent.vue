<template>
  ...
  <div class="lg:flex lg:space-x-16">
    <div class="lg:w-[640px]">
      <div class="border-2 border-slate-gray rounded-lg mt-10 p-6 text-body1">
        ...
        <div class="mt-4 space-y-4">
          ...
          <p>
            {{ clientInfo?.country }} {{ clientInfo?.state }} {{ clientInfo?.city }}
            {{ clientInfo?.address }} {{ clientInfo?.postal_code }}
          </p>
        </div>
      </div>
      <div class="mt-10 text-center">
        <h4 class="text-h4">Payment information</h4>
        <form class="mt-4 max-w-xs lg:max-w-xl mx-auto lg:mx-0">
          <fieldset class="flex flex-wrap text-subtitle1">
            ...
            <div class="flex items-center space-x-2 mt-4 lg:mt-0 lg:ml-4">
              <input
                class="w-5 h-5"
                type="radio"
                name="pay_method"
    ...
    <div class="border-2 lg:w-[384px] border-slate-gray rounded-lg mt-10 p-6">
      ...
      >
        ...
        <div class="flex">
          ...
          <div class="ml-2">
            ...
            <p class="text-body1">${{ Math.round(product?.totalPrice / product?.count) }}.00</p>
          </div>
        </div>
        <div class="ml-9">
